# Generated by Django 3.2.8 on 2021-10-31 01:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(max_length=16)),
                ('messaging_service', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='twilio_management.messagingservice')),
            ],
            options={
                'abstract': False,
            },
